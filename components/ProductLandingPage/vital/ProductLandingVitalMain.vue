...
<i18n> 
  {
    "en": {
      "title": "Vital for your health!",
      "subtitle": {
        "p1": "Solle<b>Vital®</b> is a premium plant blend consisting of three balanced ingredient groups: <b>adaptogens, trace minerals</b>, and our <b>chlorophyll</b> blend.",
        "p2": "These blends work together to provide essential nutrients that strengthen core body systems such as the circulatory, digestive, respiratory and immune systems, promote recovery, and lift energy and mood."
      },
    ...
    "es": {
      "title": "¡Vital para tu salud!",
      "subtitle": {
        "p1": "Solle<b>Vital®</b> es una mezcla de plantas de primera que consiste en tres grupos de ingredientes balanceados: <b>adaptógenos, minerales traza</b>, y nuestra mezcla de <b>clorofilas</b>.",
        "p2": "Estas mezclas combinadas, funcionan para brindar nutrientes esenciales que fortalecen los sistemas centrales del cuerpo: circulatorio, digestivo, respiratorio e inmunológico, promoviendo la recuperación y mejorando la energía y el estado de ánimo."
      },
          ...
          <div class="main__box">
            ...
            <product-landing-animation :delay="700" class="isTablet">
              <div class="main__img">
                <img
                  :src="
                    require('~/assets/ProductLandingPages/images/vital/vital-box.png')
                  "
                  alt="VitalBox"
                />
              </div>
